...
func (r *fakeCommandRouter) Resolve(context.Context, int64) (PlayerServerInstance, error) {
	return r.route, nil
}
...
func (f fakeGameCommandClientFactory) ClientFor(context.Context, PlayerServerInstance) (GameCommandClient, error) {
...
func TestCommandForwarderForwardsToResolvedPlayerServer(t *testing.T) {
	router := &fakeCommandRouter{route: PlayerServerInstance{InstanceID: "game-1", GrpcAddr: "127.0.0.1:9001"}}
